...
// document.write(" Last index of 'l': " +indexno);
...
// document.write(str + "<br>");
// document.write(" character at index 3: " + indexno);
...
// var user_demand =prompt("welcome to My bakery,What do you want to order sir/ma'am?");
...
// var string_to_arr = university_name.split('');
...
// alert(`There are ${(text.match(pattern)).length} occurences of word "the"`)
...
// var later_date = new Date("June 22, 2020");
...
// document.write("First Ramadan Date Of Year 2020 : " + b + "<br>");
// a= a.getTime();
// b=b.getTime();
// var d = a-b;
// var dd = d/(1000*60*60*24);
// dd = Math.floor(dd);
// document.write( dd + " Days Have Passed Since 1st Ramadan,2020 " + "<br>");
// alert( dd + " Days Have Passed Since 1st Ramadan,2020 ");
...
// document.write(dd+" seconds had passed since beginning of 2020" + "<br>");
...
// var a =new Date();
// var b =new Date(prompt ('Enter your date of birth in this format january 01, 1997 ' ));
// document.write("Your Date of birth : " + b + "<br>");
// a= a.getTime();
// var bb=b.getTime();
// var d = a-bb;
...
//   function calc(num1,opr,num2,user){
//        if(opr==="+"){
...
//     else{
//          alert("Your operator is Invalid.Please put valid operator");
//      }
...
// var check="";
// var word = prompt("Enter any word of your name or something else");
...
// function lower_case_to_upper_case(str) 
// {
// str = str.split(" ");
...
// alert(lower_case_to_upper_case("the quick brown fox"));
